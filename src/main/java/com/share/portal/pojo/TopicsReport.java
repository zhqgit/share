...
public class TopicsReport {
    ...
    private String topicsCommentId;

    public TopicsReport(Integer id, String type, String description, String reporteUser, String beReportedUser, Date created, Date updated, String topicsCommentId) {
        this.id = id;
        this.type = type;
        ...
        this.topicsCommentId = topicsCommentId;
    }
    ...
    public String getTopicsCommentId() {
        return topicsCommentId;
    }

    public void setTopicsCommentId(String topicsCommentId) {
        this.topicsCommentId = topicsCommentId == null ? null : topicsCommentId.trim();
    }
}